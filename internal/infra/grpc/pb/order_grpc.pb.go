...
type OrderServiceClient interface {
	...
	ListOrders(ctx context.Context, in *BlankRequest, opts ...grpc.CallOption) (*ListOrdersResponse, error)
}
...
func (c *orderServiceClient) ListOrders(ctx context.Context, in *BlankRequest, opts ...grpc.CallOption) (*ListOrdersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type OrderServiceServer interface {
	...
	ListOrders(context.Context, *BlankRequest) (*ListOrdersResponse, error)
...
func (UnimplementedOrderServiceServer) ListOrders(context.Context, *BlankRequest) (*ListOrdersResponse, error) {
