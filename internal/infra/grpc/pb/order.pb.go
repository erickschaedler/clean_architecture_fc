...
const file_internal_infra_grpc_protofiles_order_proto_rawDesc = "" +
	...
	"\x06orders\x18\x01 \x03(\v2\x11.pb.OrderResponseR\x06orders2\x86\x01\n" +
	"\fOrderService\x12>\n" +
	"\vCreateOrder\x12\x16.pb.CreateOrderRequest\x1a\x17.pb.CreateOrderResponse\x126\n" +
	"\n" +
	"ListOrders\x12\x10.pb.BlankRequest\x1a\x16.pb.ListOrdersResponseB\x18Z\x16internal/infra/grpc/pbb\x06proto3"
...
var file_internal_infra_grpc_protofiles_order_proto_goTypes = []any{
	...
	(*BlankRequest)(nil),        // 2: pb.BlankRequest
...
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	...
	2, // 2: pb.OrderService.ListOrders:input_type -> pb.BlankRequest
